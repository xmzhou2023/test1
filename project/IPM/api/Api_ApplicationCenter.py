...
Api = APIRequest()
def get_applicationcenter_DCP_agree(proname,task_name):
    '''
    应用中心_DCP看板_同意预约
...
def get_applicationcenter_DCP_agree_sendMail(proname,task_name):
    '''
    ...
    if bid == '请求成功':
        ...
        logging.info('当前同意预约调用结果为{}'.format(bid))
        raise ValueError('当前同意预约调用结果为{}'.format(bid))
def get_applicationcenter_DCP_agree_approveAppointment(proname,task_name):
    '''
    应用中心_DCP看板_同意预约_审批
    param templname:项目模板名称
    param projectname:项目名称
...
if __name__ == '__main__':
    # print(get_applicationcenter_DCP_agree("IPM自动化测试2022-12-2316:56:38","任务名称2022-12-2316:56:38"))
    # print(get_applicationcenter_DCP_agree_sendMail("IPM自动化测试2022-12-2216:24:36","任务名称2022-12-2216:24:36"))
    print(get_applicationcenter_DCP_agree_approveAppointment("IPM自动化测试2022-12-2216:24:36","任务名称2022-12-2216:24:36"))