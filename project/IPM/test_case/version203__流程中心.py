...
class Teststory_3285:
    ...
    def test_27177(self, drivers):
        ...
        self.vars["window_handles"] = robot.window_handles
        robot.AI_find_element(By.XPATH, "//div[@id='pane-apply']/div/details/div/div/div/div[2]").click()#idb14b48de-1e16-4fe9-a9c0-c9b5796ebafb
