...
class TestComponentTransfer:
    ...
    def test_001_001(self, drivers):  # 用例名称取名规范'test+场景编号+用例编号'
        ...
        tools.input('迁移选择框', '我的空间', 'choose')
        tools.click('迁移选择框')
        tools.click('迁移目标路径', '我的空间')
    ...
    def test_001_002(self, drivers):  # 用例名称取名规范'test+场景编号+用例编号'
        ...
        tools.input('迁移选择框', 'auto_testing_add_files_pri_001', 'choose')
        tools.click('迁移选择框')
        tools.click('迁移目标路径', 'auto_testing_add_files_pri_001')
        tools.click('迁移弹框按钮', 'confirm')
        DomAssert(drivers).assert_att('迁移成功')
        # 删除组件
        tools.click_menu('组件中心', '我的文件')
    ...
    def test_001_003(self, drivers):  # 用例名称取名规范'test+场景编号+用例编号'
        ...
        tools.click('组件Item more')
        tools.click('迁移', 'auto_testing_add_components_pri_001')
        tools.input('迁移选择框', '公共空间', 'choose')
        tools.click('迁移选择框')
        tools.click('迁移目标路径', '公共空间')
        tools.click('迁移弹框按钮', 'confirm')
        DomAssert(drivers).assert_att('迁移成功')
        # 删除组件
        tools.click_menu('组件中心', '我的文件')
    ...
    def test_001_004(self, drivers):  # 用例名称取名规范'test+场景编号+用例编号'
        ...
        tools.click('组件Item more')
        tools.click('迁移', 'auto_testing_add_components_pri_001')
        tools.input('迁移选择框', 'auto_testing_add_files_pub_001', 'choose')
        tools.click('迁移选择框')
        tools.click('迁移目标路径', 'auto_testing_add_files_pub_001')
        tools.click('迁移弹框按钮', 'confirm')
        DomAssert(drivers).assert_att('迁移成功')
        # 删除组件
        tools.click_menu('组件中心', '我的文件')
