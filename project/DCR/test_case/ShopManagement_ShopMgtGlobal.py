...
class TestEditShop():
    ...
    def test_001_002(self, drivers):
        ...
        success_text = edit_shop.get_text_edit_success()
        ValueAssert.value_assert_equal(success_text, "Edited Successfully")
        sleep(1)
...
class TestDeleteShop():
    ...
    def test_001_003(self, drivers):
        ...
        """获取删除成功提示语, 删除成功后显示No Data提示语"""
        success_text = del_shop.get_text_del_success()
        ValueAssert.value_assert_equal(success_text, "Successfully")
        sleep(1)
