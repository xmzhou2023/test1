...
class TestQueryCustomerSalesReport:
    ...
    def test_001_001(self, drivers):
        ...
        sales_report.input_date("2022-07-15", "2022-07-22")
        ...
        #查询国包用户下出库单总数
        user = SQL('DCR', 'test')
        del_result = user.query_db("select count(delivery_code) as sum from t_channel_delivery_ticket  where warehouse_id='62139' and seller_id='1596874516539667' and status=80200001 and delivery_date between '2022-07-15' and '2022-07-22'")
        de_total = del_result[0].get('sum')

        #查询BD40344201国包用户下 已退货的总数
        return_result = user.query_db("select count(delivery_code) as sum from t_channel_delivery_ticket  where warehouse_id = '62139' and seller_id = '1596874516539667' and return_status = 1 and delivery_date between '2022-07-15' and '2022-07-22'")
