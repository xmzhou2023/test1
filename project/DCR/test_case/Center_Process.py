...
class TestSalesBusinessProcess:
    ...
    @allure.title("销售单页面，二代新增有码销售单操作")
    @allure.description("销售单页面，二代新增有码销售单操作成功后，校验新增的销售单是否存在")
