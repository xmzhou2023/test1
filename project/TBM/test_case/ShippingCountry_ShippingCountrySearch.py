...
class TestCreateProcess:
    ...
    def test_001_002(self, drivers): # 用例名称取名规范'test+场景编号+用例编号'
        ...
        user.edit_oneworks_product_definition_info('BAND STRATEGY', '拉美市场')
        user.edit_oneworks_product_definition_info('项目经理', '李小素')
        user.edit_oneworks_product_definition_info('摄像头', '摄像头')
        user.edit_oneworks_product_definition_info('型号', '型号')
        user.edit_oneworks_product_definition_info('新增', '新增')
        user.edit_oneworks_product_definition_info('再增', '2G')
        user.edit_oneworks_product_definition_info('配色', '魅海蓝/Aqua Blue')
...
class TestTheProcessOfExaminationAndApproval:
    ...
    def test_002_003(self, drivers, SaleCountry_ProductChange_Join_API):  # 用例名称取名规范'test+场景编号+用例编号'
        ...
        user.edit_oneworks_product_definition_info('BAND STRATEGY', '公开市场')
