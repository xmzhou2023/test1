...
class TestCreateProcess:
    ...
    @allure.story("创建流程")  # 场景名称
    @allure.title("生产工厂信息导入正确,创建流程成功")  # 用例名称
    @allure.description("进入新增页面制作类型选择客供BOM衍生，BOM信息填写完整，在衍生BOM制作需求中新增物料后，点击生成BOM，点击生产工厂信息中的导入，下载模板，填写正确的信息，选择正确的模板，点击应用，导入内容正确，填写业务审核，点击提交，提示流程发起成功")
    @allure.severity("normal")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    ...
    @allure.story("创建流程")  # 场景名称
    @allure.title("生产工厂信息导入正确,取消导入")  # 用例名称
    @allure.description("进入新增页面制作类型选择客供BOM衍生，BOM信息填写完整，在衍生BOM制作需求中新增物料后，点击生成BOM，点击生产工厂信息中的导入，下载模板，填写正确的信息，选择正确的模板，点击取消，导入失败")
    @allure.severity("normal")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    ...
    def test_001_015(self, drivers):
        ...
        user.assert_toast('创建流程成功')
        user.refresh()
        user.assert_add_result('自动化新增用例cy', '客供BOM衍生', '1005G1', 'itel', '量产阶段', '审批中', '埃塞本地')
...
class TestTheProcessOfExaminationAndApproval:
    ...
    @allure.story("流程审批")  # 场景名称
    @allure.title("业务审核页面，取消成功，页面无变化")  # 用例名称
    ...
    @allure.story("流程审批")  # 场景名称
    @allure.title("发起客供BOM衍生流程，审批页面的数据和发起的数据是一致的")  # 用例名称
    @allure.description("发起一个客供BOM衍生，进入待办中心，点击该条单据进行查看，查看页面的数据和发起的数据是一致的")
    @allure.severity("normal")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    def test_003_013(self, drivers):
        user = ForeignBom(drivers)
        user.refresh_webpage_click_menu()
        user.click_add()
        user.input_basic_info('标题', '自动化新增用例')
    ...
    @allure.story("流程审批")  # 场景名称
    @allure.title("衍生-业务审核页面，审核成功")  # 用例名称
    @allure.description("在业务审核页面，所有数据正确填写，点击同意，能成功提交，并给出提示处理成功，并且页面成功跳转")
    @allure.severity("normal")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    def test_003_014(self, drivers, Foreign_Derived_API):
        user = ForeignBom(drivers)
        user.refresh_webpage()
    ...
    @allure.story("流程审批")  # 场景名称
    @allure.title("衍生-业务审核页面，取消成功，页面无变化")  # 用例名称
    @allure.description("在业务审核页面，所有数据正确填写，点击同意，弹出弹框确认同意？，点击取消，取消成功，页面无变化")
    @allure.severity("normal")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    def test_003_015(self, drivers, Foreign_Derived_API):
        user = ForeignBom(drivers)
        user.refresh_webpage()
        user.enter_oneworks_edit(Foreign_Derived_API[0])
        user.click_oneworks_agree()
    ...
    @allure.story("流程审批")
    @allure.title("衍生-在业务审核页面中，不选择转交人转交，不存在确定转交按钮")
    @allure.description("在业务审核页面中，点击转交，不选择转交的人直接点击确认，是不存在确定转交按钮")
    @allure.severity("normal")  # blocker\critical\normal\minor\trivial
    @pytest.mark.UT
    def test_003_016(self, drivers, Foreign_Derived_API):
        user = ForeignBom(drivers)
        user.refresh_webpage()
        user.assert_my_todo_node(Foreign_Derived_API[0], '业务审核', True)
        user.enter_oneworks_edit(Foreign_Derived_API[0])
    ...
    @allure.story("流程审批")
    @allure.title("衍生-在业务审核页面中，选择转交人转交，存在确定转交按钮")
    @allure.description("在业务审核页面中，点击转交，选择转交的人直接点击确认，存在确定转交按钮")
    @allure.severity("normal")  # 用例等级
    @pytest.mark.UT  # 用例标记
    def test_003_017(self, drivers, Foreign_Derived_API):
        user = ForeignBom(drivers)
        user.refresh_webpage()
        user.assert_my_todo_node(Foreign_Derived_API[0], '业务审核', True)
        user.enter_oneworks_edit(Foreign_Derived_API[0])
    ...
    @allure.story("流程审批")
    @allure.title("衍生-在业务审核页面中，选择转交人转交取消，存在转交，回退按钮")
    @allure.description("在业务审核页面中，点击转交，选择转交的人后点击取消按钮，页面中恢复到原来的页面（判断是否存在转交，回退按钮）")
    @allure.severity("normal")  # 用例等级
    @pytest.mark.UT  # 用例标记
    def test_003_018(self, drivers, Foreign_Derived_API):
        user = ForeignBom(drivers)
        user.refresh_webpage()
        user.assert_my_todo_node(Foreign_Derived_API[0], '业务审核', True)
        user.enter_oneworks_edit(Foreign_Derived_API[0])
    ...
    @allure.story("流程审批")  # 场景名称
    @allure.title("衍生-在业务审核页面中，转交单据成功")  # 用例名称
    @allure.description("在业务审核页面中，点击转交，选择转交的人直接点击确认，点击确定转交，页面跳转，并且该条单据转交到选择的人身上")
    @allure.severity("normal")  # 用例等级
    @pytest.mark.UT  # 用例标记
    def test_003_019(self, drivers, Foreign_Derived_API):
        user = ForeignBom(drivers)
        user.refresh_webpage()
        user.assert_my_todo_node(Foreign_Derived_API[0], '业务审核', True)
        user.enter_oneworks_edit(Foreign_Derived_API[0])
    ...
    @allure.severity("normal")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    def test_003_020(self, drivers, Foreign_Derived_API):
        user = ForeignBom(drivers)
        user.refresh_webpage()
        user.assert_my_todo_node(Foreign_Derived_API[0], '业务审核', True)
        user.enter_oneworks_edit(Foreign_Derived_API[0])
    ...
    @allure.story("流程审批")  # 场景名称
    @allure.title("衍生-在数据组审批页面中，回退到业务审核再审核，还是数据组审批节点")  # 用例名称
    @allure.description("在数据组审批页面中，点击回退，选择回退到业务审核页面，查看我的待办中存在业务审核节点，在业务审核同意并审核成功，下个节点是数据组审核节点")
    @allure.severity("normal")  # 用例等级
    @pytest.mark.UT  # 用例标记
    def test_003_021(self, drivers, Foreign_Derived_Approval_API):
        user = ForeignBom(drivers)
        user.refresh_webpage()
    ...
    @allure.story("流程审批")
    @allure.title("衍生-在在数据组审批页面中，不选择转交人转交，不存在确定转交按钮")
    @allure.description("在数据组审批页面中中，点击转交，不选择转交的人直接点击确认，是不存在确定转交按钮")
    @allure.severity("normal")  # blocker\critical\normal\minor\trivial
    @pytest.mark.UT
    def test_003_022(self, drivers, Foreign_Derived_Approval_API):
        user = ForeignBom(drivers)
        user.refresh_webpage()
        user.assert_my_todo_node(Foreign_Derived_Approval_API[0], '数据组审批', True)
        user.enter_oneworks_edit(Foreign_Derived_Approval_API[0])
    ...
    @allure.story("流程审批")
    @allure.title("衍生-在数据组审核页面中，选择转交人转交，存在确定转交按钮")
    @allure.description("在数据组审核页面中，点击转交，选择转交的人直接点击确认，存在确定转交按钮")
    @allure.severity("normal")  # 用例等级
    @pytest.mark.UT  # 用例标记
    def test_003_023(self, drivers, Foreign_Derived_Approval_API):
        user = ForeignBom(drivers)
        user.refresh_webpage()
        user.assert_my_todo_node(Foreign_Derived_Approval_API[0], '数据组审批', True)
        user.enter_oneworks_edit(Foreign_Derived_Approval_API[0])
    ...
    @allure.story("流程审批")
    @allure.title("衍生-在数据组审批页面中，选择转交人转交取消，存在转交，回退按钮")
    @allure.description("在数据组审批页面中，点击转交，选择转交的人后点击取消按钮，页面中恢复到原来的页面（判断是否存在转交，回退按钮）")
    @allure.severity("normal")  # 用例等级
    @pytest.mark.UT  # 用例标记
    def test_003_024(self, drivers, Foreign_Derived_Approval_API):
        user = ForeignBom(drivers)
        user.refresh_webpage()
        user.assert_my_todo_node(Foreign_Derived_Approval_API[0], '数据组审批', True)
        user.enter_oneworks_edit(Foreign_Derived_Approval_API[0])
    ...
    @allure.story("流程审批")  # 场景名称
    @allure.title("衍生-在数据组审核页面中，转交单据成功")  # 用例名称
    @allure.description("在数据组审核页面中，点击转交，选择转交的人直接点击确认，点击确定转交，页面跳转，并且该条单据转交到选择的人身上")
    @allure.severity("normal")  # 用例等级
    @pytest.mark.UT  # 用例标记
    def test_003_025(self, drivers, Foreign_Derived_Approval_API):
        user = ForeignBom(drivers)
        user.refresh_webpage()
        user.assert_my_todo_node(Foreign_Derived_Approval_API[0], '数据组审批', True)
        user.enter_oneworks_edit(Foreign_Derived_Approval_API[0])
...
class TestProcessApprovalExceptionScenario:
    ...
    @allure.severity("normal")  # 用例等级
    @pytest.mark.UT  # 用例标记
    def test_004_002(self, drivers, Foreign_Derived_Approval_API):
        user = ForeignBom(drivers)
        user.refresh_webpage()
        user.assert_my_todo_node(Foreign_Derived_Approval_API[0], '数据组审批', True)
        user.enter_oneworks_edit(Foreign_Derived_Approval_API[0])
