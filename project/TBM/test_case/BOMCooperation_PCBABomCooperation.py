...
class TestCreateProcess:
    ...
    def test_001_002(self, drivers):
        ...
        user.input_bomtree('PCBA', '数量', '1')
        user.input_bomtree('PCB', '物料编码', '12105820')
        user.input_bomtree('PCB', '数量', '1')
    ...
    def test_001_007(self, drivers):
        ...
        user.input_bomtree('PCB', '替代组', 'A1')
        user.input_bomtree('PCB', '份额', '20')
        user.click_bomtree_delete('PCB')
        user.assert_BomTree_result('PCB', '物料编码', '', 'Tree')
        user.assert_BomTree_result('PCB', '数量', '', 'Tree')
        user.assert_BomTree_result('PCB', '替代组', '', 'Tree')
        user.assert_BomTree_result('PCB', '份额', '', 'Tree')
