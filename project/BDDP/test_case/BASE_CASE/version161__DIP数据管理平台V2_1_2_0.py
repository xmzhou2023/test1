...
class Teststory_2798:
    ...
    def test_30875(self, drivers):
        ...
        robot.AI_find_element(By.XPATH, "//div[2]/div[3]/button/span").click()  # id0c0244bd-7b65-46ea-9468-1e744ea81268
        robot.AI_find_element(By.XPATH, "//textarea").click()  # id8e65d049-801e-44e7-bb4d-e149bbd931dd
        robot.AI_find_element(By.XPATH, "//div[2]/div[2]/div[2]/div[2]/div[2]/div[2]/div/label/span/span").click()  # id8e65d049-801e-44e7-bb4d-e149bbd931dd
        robot.AI_find_element(By.XPATH, "//textarea").send_keys("销售年情况")  # idfb1077c3-5ffa-41ee-a2d4-c7c93fe00d0e
        user.assert_input('新建说明', '销售年情况')
        user.click_card()  # id08a75066-5f43-44ef-9c09-b31e3c01cd00
    ...
    def test_30862(self, drivers):
        ...
        DomAssert(drivers).assert_att('陈佳杰18649692')
        robot.AI_find_element(By.XPATH,
        ...
        robot.AI_find_element(By.XPATH,
                              "//span[contains(.,'王佳18649692')]").click()  # id1a7ae198-2390-4b8f-ace0-55636a61907b
        user.assert_input('需求提出人', '王佳18646861')
        DomAssert(drivers).assert_att('王佳18646861')
        robot.AI_find_element(By.XPATH,
                              "(//div[7]/div/div/div/div").click()  # id630b7b76-b226-4453-b976-493b0e3d9066
        robot.AI_find_element(By.XPATH,
                              "(//div[7]/div/div/div/div/div").click()  # id630b7b76-b226-4453-b976-493b0e3d9066
        DomAssert(drivers).assert_att('易为控股')
        robot.AI_find_element(By.XPATH,
                              "(//input[@type='text'])[6]").click()  # id630b7b76-b226-4453-b976-493b0e3d9066
        robot.AI_find_element(By.XPATH,
                              "(//input[@type='text'])[6]").clear()  # id630b7b76-b226-4453-b976-493b0e3d9066
        robot.AI_find_element(By.XPATH, "(//input[@type='text'])[6]").send_keys(
            "郭程")  # id1a973597-8457-4c93-871b-647a5e5d651e
        robot.AI_find_element(By.XPATH,
                              "//span[contains(.,'王佳18649692')]").click()  # id1a7ae198-2390-4b8f-ace0-55636a61907b
        user.assert_input('需求提出人', '郭程18653497')
        DomAssert(drivers).assert_att('郭程18653497')
        robot.AI_find_element(By.XPATH,
                              "(//input[@type='text'])[7]").click()  # id630b7b76-b226-4453-b976-493b0e3d9066
        robot.AI_find_element(By.XPATH,
                              "(//li[contains(.,'关注')]").click()  # id630b7b76-b226-4453-b976-493b0e3d9066
        DomAssert(drivers).assert_att('关注')
        robot.AI_find_element(By.XPATH, "(//input[@type='text'])[9]").click()  # id08a75066-5f43-44ef-9c09-b31e3c01cd00
        robot.AI_find_element(By.XPATH, "(//input[@type='text'])[9]").send_keys(
            "test")  # idc6289502-af33-4620-94fe-df696d45087a
        DomAssert(drivers).assert_att("test")
        robot.AI_find_element(By.XPATH, "//span[contains(.,'确定')]").click()  # idb61adb68-2f38-4b49-9485-4a351657b5d9
    ...
    def test_30864(self, drivers):
        ...
        DomAssert(drivers).assert_att('测试5')
        robot.AI_find_element(By.XPATH,
                              "//div[2]/table/tbody/tr[3]/td[11]/div/button[3]/span/i").click()  # idaa9f333a-6f7a-4e44-874c-b9ad82f4b7af
        robot.AI_find_element(By.XPATH,
    ...
    def test_30874(self, drivers):
        ...
        robot.AI_find_element(By.XPATH,
                              "//div[2]/div[2]/div[2]/div[2]/div[2]/div/div/label/span/span").click()  # id0eeb066f-3867-460f-b2d8-f977384ea9a4
        robot.AI_find_element(By.XPATH,
                              "//div[2]/div/input").click()
        robot.AI_find_element(By.XPATH,
                              "//div[2]/div/input").send_keys("销售")
        robot.AI_find_element(By.XPATH,
                              "//span[contains(.,'查询')]").click()
        robot.AI_find_element(By.XPATH, "//div[2]/div[3]/button/span").click()  # id0c0244bd-7b65-46ea-9468-1e744ea81268
        DomAssert(drivers).assert_att("销售")
...
class Teststory_2499:
    ...
    def test_30917(self, drivers):
        ...
        time.sleep(2)
        robot.AI_find_element(By.XPATH, "//div[@id='app']/div/div[2]/section/div/div/div/div[2]/h3/form/div/div/div/div/div/input").click()  # id31d7380e-8987-45d6-809c-5846808b2d73
        name = 'name{}'.format(datetime.now().strftime("%Y%m%d%H%M%S"))
        robot.AI_find_element(By.XPATH, "//input[@type='text']").send_keys(name)  # id4c0658e8-547b-4fae-b587-5d420c7543f9
        robot.AI_find_element(By.XPATH,
                              "//textarea").click()
        robot.AI_find_element(By.XPATH,
