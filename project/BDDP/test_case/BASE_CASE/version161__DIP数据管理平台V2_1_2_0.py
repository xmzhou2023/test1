...
class Teststory_2798:
    ...
    def test_30691(self, drivers):
        ...
        user.assert_input('业务组织', '深圳传音控股')
        user.click_homepage()
        user.click_homepage1()
        user.click_homepage2()
        user.click_homepage3()
        user.click_card()
        user.click_share()
        DomAssert(drivers).assert_att('分享')
        user.click_targer_01()
        user.click_targer_02()
        user.click_targersure01()
        user.click_explain()
        user.click_explain1()
        user.assert_input('新建说明', '销售年情况')
