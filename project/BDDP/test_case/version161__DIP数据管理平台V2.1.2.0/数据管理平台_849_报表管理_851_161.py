...
class Teststory_2798:
    ...
    @allure.description(
        "步骤1:登录PC端后台管理系统;步骤2:点击卡片管理新建;步骤3:选择卡片名称应用类型移动端;步骤4:输入主题域选择业务域;步骤5:选择业务负责人.业务组织IT负责人;步骤6:选择卡片组件分享;步骤7:选择是否公开是;步骤8:选择首页卡片池否;步骤9:选择下钻报表财务销售经营分析供应链库存金额;步骤10:选择分析指标选择多项指标;步骤11:输入说明499字;步骤12:配置英文属性卡片名销售明细，说明销售各类明细;")  # 用例描述
    ...
    @allure.description(
        "步骤1:登录PC端后台管理系统;步骤2:点击卡片管理新建;步骤3:选择卡片名称应用类型移动端;步骤4:输入主题域选择业务域;步骤5:选择业务负责人.业务组织IT负责人;步骤6:选择卡片组件分享;步骤7:选择是否公开公开;步骤8:选择首页卡片池是;步骤9:选择下钻报表财务销售经营分析供应链库存金额;步骤10:选择分析指标选择多项指标;步骤11:输入说明499字;步骤12:配置英文属性卡片名销售明细，说明销售各类明细;")  # 用例描述
    @allure.severity("blocker")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    ...
    @allure.description(
        "步骤1:登录PC端后台管理系统;步骤2:选择已新建成功的卡片;步骤3:点击编辑;步骤4:修改需求提出人;步骤5:修改业务负责人.业务组织IT负责人;步骤6:修改卡片组件;步骤7:修改是否公开;步骤8:修改首页卡片池;步骤9:修改下钻报表财务销售经营分析供应链库存金额;步骤10:修改分析指标选择2项指标;步骤11:输入说明18字;步骤12:配置英文属性卡片名销售明细，说明销售各类明细;")  # 用例描述
    @allure.severity("blocker")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    ...
    @allure.description(
        "步骤1:登录PC端后台管理系统;步骤2:点击卡片管理新建;步骤3:选择卡片名称应用类型移动端;步骤4:输入主题域选择业务域;步骤5:选择业务负责人.业务组织IT负责人;步骤6:选择卡片组件分享;步骤7:选择是否私有私有;步骤8:选择首页卡片池是;步骤9:选择下钻报表财务销售经营分析供应链库存金额;步骤10:选择分析指标选择一项指标;步骤11:输入说明499字;步骤12:配置英文属性卡片名销售明细，说明销售各类明细;")  # 用例描述
    @allure.severity("blocker")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    ...
    @allure.description(
        "步骤1:登录PC端后台管理系统;步骤2:点击卡片管理新建;步骤3:选择卡片名称应用类型PC端;步骤4:输入主题域选择业务域;步骤5:选择业务负责人.业务组织IT负责人;步骤6:选择卡片组件分享;步骤7:选择是否公开是;步骤8:选择首页卡片池否;步骤9:选择下钻报表财务销售经营分析供应链库存金额;步骤10:选择分析指标选择多项指标;步骤11:输入说明499字;步骤12:配置英文属性卡片名销售明细，说明销售各类明细;")  # 用例描述
    @allure.severity("blocker")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    ...
    @allure.description(
        "步骤1:登录PC端后台管理系统;步骤2:点击卡片管理新建;步骤3:选择卡片名称应用类型PC端;步骤4:输入主题域选择业务域;步骤5:选择业务负责人.业务组织IT负责人;步骤6:选择卡片组件分享;步骤7:选择是否公开是;步骤8:选择首页卡片池是;步骤9:选择下钻报表财务销售经营分析供应链库存金额;步骤10:选择分析指标选择多项指标;步骤11:输入说明499字;步骤12:配置英文属性卡片名销售明细，说明销售各类明细;")  # 用例描述
    @allure.severity("blocker")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    ...
    @allure.description(
        "步骤1:登录PC端后台管理系统;步骤2:点击卡片管理新建;步骤3:选择卡片名称应用类型PC端;步骤4:输入主题域选择业务域;步骤5:选择业务负责人.业务组织IT负责人;步骤6:选择卡片组件分享;步骤7:选择是否公开否;步骤8:选择首页卡片池是;步骤9:选择下钻报表财务销售经营分析供应链库存金额;步骤10:选择分析指标选择多项指标;步骤11:输入说明499字;步骤12:配置英文属性卡片名销售明细，说明销售各类明细;")  # 用例描述
    @allure.severity("blocker")  # 用例等级
    @pytest.mark.smoke  # 用例标记
...
class Teststory_2499:
    ...
    @allure.description(
        "步骤1:登录PC端后台管理系统;步骤2:点击角色管理新建;步骤3:输入角色名称;步骤4:输入角色说明;步骤5:拥有首页卡片池否;步骤6:选择菜单报表授权;步骤7:输入关联用户;步骤8:点击保存;")  # 用例描述
    @allure.severity("blocker")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    ...
    @allure.description(
        "步骤1:登录PC端后台管理系统;步骤2:点击角色管理新建;步骤3:输入角色名称;步骤4:输入角色说明;步骤5:拥有首页卡片池是;步骤6:选择菜单报表授权;步骤7:输入关联用户;步骤8:点击保存;")  # 用例描述
    @allure.severity("blocker")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    ...
    @allure.description(
        "步骤1:登录PC端后台管理系统;步骤2:选择已有的角色，点击编辑;步骤3:修改角色名称;步骤4:修改角色说明;步骤5:修改拥有首页卡片池否;步骤6:修改菜单报表授权;步骤7:修改关联用户;步骤8:点击保存;")  # 用例描述
    @allure.severity("blocker")  # 用例等级
    @pytest.mark.smoke  # 用例标记
