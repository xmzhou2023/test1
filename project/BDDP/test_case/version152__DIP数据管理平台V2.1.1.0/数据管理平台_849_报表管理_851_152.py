...
class Teststory_2492:
    ...
    @allure.description(
        "步骤1:登录PC端后台管理系统;步骤2:点击报表管理新建;步骤3:选择报表名称应用类型移动端;步骤4:输入主题域选择业务域;步骤5:选择业务负责人.业务组织IT负责人;步骤6:选择页面来源定制;步骤7:选择报表首页差异化是;步骤8:选择报表类型事业部;步骤9:进入角色管理中心进行数据授权;步骤10:来源卡片财务销售事业分析部私有化卡片;步骤11:访问地址:输入外部地址;步骤12:选择指标财务销售事业分析部;步骤13:说明销售事业公析;")  # 用例描述
    @allure.severity("blocker")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    ...
    @allure.description(
        "步骤1:登录PC端后台管理系统;步骤2:点击报表管理选择已启用的报表;步骤3:修改报表名称应用类型移动端;步骤4:输入主题域选择业务域;步骤5:修改业务负责人.业务组织IT负责人;步骤6:修改页面来源卡片组合;步骤7:修改报表首页差异化是;步骤8:进入角色管理中心进行数据授权;步骤9:修改报表类型总部;步骤10:修改卡片来源财务销售事业分析部;步骤11:修改指标财务销售事业分析部;步骤12:修改说明销售事业公析;步骤13:点击保存后再点击删除;")  # 用例描述
    @allure.severity("blocker")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    ...
    @allure.description(
        "步骤1:登录PC端后台管理系统;步骤2:点击报表管理新建;步骤3:选择报表名称应用类型移动端;步骤4:输入主题域选择业务域;步骤5:选择业务负责人.业务组织IT负责人;步骤6:选择报表组件分享;步骤7:选择是否公开公开;步骤8:选择首页报表池是;步骤9:搜索下钻报表财务销售经营分析供应链库存金额;")  # 用例描述
    @allure.severity("blocker")  # 用例等级
    @pytest.mark.smoke  # 用例标记
