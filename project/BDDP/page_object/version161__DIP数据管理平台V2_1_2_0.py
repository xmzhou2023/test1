...
class kapianguanli(Base):
    ...
    @allure.step("选择分析指标1")
    def click_targer_02(self):
        self.is_click(user['选择分析指标1'])

    @allure.step("选择分析指标2")
    def click_targer_03(self):
        self.is_click(user['选择分析指标2'])
    ...
    @allure.step("指标确定1")
    def click_targersure01(self):
        self.is_click(user['指标确定1'])
