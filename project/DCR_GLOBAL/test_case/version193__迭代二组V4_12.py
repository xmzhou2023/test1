...
class Teststory_3158:
    ...
    @allure.story("自定义模板")  # 用户故事名称
    @allure.title("新增模版界面默认显示自定义模版")  # 用例名称
    @allure.description("None")  # 用例描述
    @allure.severity("normal")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    ...
    @allure.story("自定义模板")  # 用户故事名称
    @allure.title("DCR数据类型ShopOpen【门店状态】不可移动不可删")  # 用例名称
    @allure.description("None")  # 用例描述
    @allure.severity("normal")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    ...
    @allure.story("自定义模板")  # 用户故事名称
    @allure.title("巡店模版页增加导出功能")  # 用例名称
    @allure.description("None")  # 用例描述
    @allure.severity("normal")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    def test_20117(self, drivers):
        pass
    ...
    @allure.story("自定义模板")  # 用户故事名称
    @allure.title("导出的模版取自VisitingRecord中最近的一个月")  # 用例名称
    @allure.description("None")  # 用例描述
    @allure.severity("normal")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    def test_20119(self, drivers):
        pass


    @allure.story("自定义模板")  # 用户故事名称
    @allure.title("导出的字段同VisitingRecord页面一致")  # 用例名称
    @allure.description("None")  # 用例描述
    @allure.severity("normal")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    def test_20120(self, drivers):
        pass


    @allure.story("自定义模板")  # 用户故事名称
    @allure.title("导出同VisitingRecord筛选查询中的一个月一致")  # 用例名称
    @allure.description("None")  # 用例描述
    @allure.severity("normal")  # 用例等级
    @pytest.mark.smoke  # 用例标记
    def test_20121(self, drivers):
        pass
