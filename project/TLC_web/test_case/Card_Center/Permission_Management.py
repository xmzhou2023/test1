...
from project.TLC_web.page_object.Card_Center.Permission_Management import Permission
...
if __name__ == '__main__':
    pytest.main(['project/TLC_web/test_case/Card_Center/Permission_Management.py'])
