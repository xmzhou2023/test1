...
#             logging.info("User Management & Authorization卡片，加载No Auth Customer WH Shop指标的值加载正常：{}".format(no_auth_cust_shop))
#         else:
#             logging.info("User Management & Authorization卡片，加载No Auth Customer WH Shop指标的值加载不正常：{}".format(no_auth_cust_shop))
#
#         country_above_auth = page_user_mgt.get_country_and_above_authority()
#         if int(country_above_auth) > 1:
#             logging.info("User Management & Authorization卡片，加载Country And Above Authority指标的值加载正常：{}".format(country_above_auth))
#         else:
#             logging.info("User Management & Authorization卡片，加载Country And Above Authority指标的值加载不正常：{}".format(country_above_auth))
#
#         trans_day_no_login = page_user_mgt.get_trans_days_no_login()
#         if int(trans_day_no_login) > 1:
#             logging.info("User Management & Authorization卡片，加载Transsion Days No Login指标的值加载正常：{}".format(trans_day_no_login))
#         else:
#             logging.info("User Management & Authorization卡片，加载Transsion Days No Login指标的值加载不正常：{}".format(trans_day_no_login))
#
#         no_menu = page_user_mgt.get_no_menu()
#         if int(no_menu) > 1:
#             logging.info("User Management & Authorization卡片，加载No menu指标的值加载正常：{}".format(no_menu))
#         else:
#             logging.info("User Management & Authorization卡片，加载No menu指标的值加载不正常：{}".format(no_menu))
#
#         no_auth_cust = page_user_mgt.get_no_auth_cust_wh()
#         if int(no_auth_cust) > 1:
#             logging.info("User Management & Authorization卡片，加载No Auth Customer WH指标的值加载正常：{}".format(no_auth_cust))
#         else:
#             logging.info("User Management & Authorization卡片，加载No Auth Customer WH指标的值加载不正常：{}".format(no_auth_cust))
#
#         cust_day_no_login = page_user_mgt.get_cust_days_no_login()
#         if int(cust_day_no_login) > 1:
#             logging.info("User Management & Authorization卡片，加载Customer Days No Login指标的值加载正常：{}".format(cust_day_no_login))
#         else:
#             logging.info("User Management & Authorization卡片，加载Customer Days No Login指标的值加载不正常：{}".format(cust_day_no_login))
#
#
# @allure.feature("Home Page")
...
#     @allure.description("Homepage首页，导出User Management& Authorization卡片的各维度数据")
...
#         date = abnormal.get_start_end_date()
#         infiltration_sale_text = abnormal.get_infiltration_sales_text()
#
#         ValueAssert.value_assert_equal("Abnormal Data", abnormal_text)
#         ValueAssert.value_assert_In("To", date)
#         ValueAssert.value_assert_equal("Infiltration Sales", infiltration_sale_text)
#
