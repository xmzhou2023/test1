...
def pytest_addoption(parser):
    ...
    parser.addoption("--remoteurl", action="store", default='http://10.250.101.58:4444', help='远程运行用例地址')  # 远程DEV环境（linux服务器）
    # parser.addoption("--remoteurl", action="store", default='http://10.250.113.16:4444', help='远程运行用例地址')  # 远程UAT环境（linux服务器）
    # parser.addoption("--remoteurl", action="store", default='http://10.250.101.49:4444', help='远程运行用例地址')  # 远程DEV环境（windows服务器）
    # parser.addoption("--remoteurl", action="store", default='http://10.250.113.15:4444', help='远程运行用例地址')  # 远程UAT环境（windows服务器）
